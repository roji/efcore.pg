...
// ReSharper restore CoVariantArrayConversion
        ...
        protected virtual void SetupEnumMappings(ISqlGenerationHelper sqlGenerationHelper)
        {
            ...
            var adoUserTypeMappings = (Dictionary<string, IUserTypeMapping>)_adoUserTypeMappingsGetMethodInfo.Invoke(NpgsqlConnection.GlobalTypeMapper, Array.Empty<object>())!;
